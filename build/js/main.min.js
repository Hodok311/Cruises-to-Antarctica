      ...
      if (entries[0].isIntersecting) {
        (0, _map.initMap)({
          ...
          placemark: [{
            ...
            iconImageHref: 'img/sprite/map-mark.svg',
            iconImageSize: [18, 22],
...
},{"./modules/form-validate/form":3,"./modules/map":9,"./modules/modals/init-modals":10,"./utils/ios-vh-fix":14}],2:[function(require,module,exports){
"use strict";
...
var createMap = function createMap(_ref) {
  ...
  var map = new window.ymaps.Map(id, initials);
  map.geoObjects.add(_construct(window.ymaps.Placemark, [map.getCenter()].concat(_toConsumableArray(placemark))));
